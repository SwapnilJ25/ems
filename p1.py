...
# VALIDATION FOR ADD WINDOW
	...
	if aw_ent_id.get()=="" or aw_ent_name.get()=="" or aw_ent_salary.get()=="":
		...
		showerror("Error","name cannot have special characters")
		...
		showerror("Error","salary cannot have special characters")
...
def f12():
	...
	plt.ylim(0, 100000)
	plt.xlabel("Name of Employee",fontweight="bold",fontsize=10)
	plt.ylabel("Salary of Employee",fontweight="bold",fontsize=10)
	plt.title("Employee Information",fontweight="bold",fontsize=10)
	#plt.legend()
	plt.grid()
	plt.show()
...
btn_add=Button(root,text="Add ",font=f,width=15,bd=4,command=f1)
btn_add.pack(pady=10)
btn_view=Button(root,text="View ",font=f,width=15,bd=4,command=f3)
btn_view.pack(pady=10)
btn_update=Button(root,text="Update ",font=f,width=15,bd=4,command=f6)
btn_update.pack(pady=10)
btn_delete=Button(root,text="Delete ",font=f,width=15,bd=4,command=f9)
btn_delete.pack(pady=10)
btn_charts=Button(root,text="Charts",font=f,width=15,bd=4,command=f12)
...
aw_lab_salary=Label(aw,text="Enter salary:",font=f,bg="light blue")
...
uw_lab_name=Label(uw,text="Enter name:",font=f,bg="light pink1")
uw_ent_name=Entry(uw,font=f,bd=2)
uw_lab_salary=Label(uw,text="Enter salary:",font=f,bg="light pink1")
